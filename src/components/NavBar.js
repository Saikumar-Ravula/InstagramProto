        ...
        <div className='nav-bar'>
            <div className='nav-bar-content'>
                ...
                <div className="nav-bar-section nav-bar-controls">
                    ...
                    <a href="/explore/" tabIndex="0"><svg aria-label="Find People" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 48 48" width="24"><path clipRule="evenodd" d="M24 0C10.8 0 0 10.8 0 24s10.8 24 24 24 24-10.8 24-24S37.2 0 24 0zm0 45C12.4 45 3 35.6 3 24S12.4 3 24 3s21 9.4 21 21-9.4 21-21 21zm10.2-33.2l-14.8 7c-.3.1-.6.4-.7.7l-7 14.8c-.3.6-.2 1.3.3 1.7.3.3.7.4 1.1.4.2 0 .4 0 .6-.1l14.8-7c.3-.1.6-.4.7-.7l7-14.8c.3-.6.2-1.3-.3-1.7-.4-.5-1.1-.6-1.7-.3zm-7.4 15l-5.5-5.5 10.5-5-5 10.5z" fillRule="evenodd"></path></svg></a>
                    ...
                    <img className="nav-profile-picture" src={Image} alt="Profile" />
